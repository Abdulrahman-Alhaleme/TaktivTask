...
export default function Search() {
    return (
        <>
            <div className="py-[10px] px-4 sm:w-[272px] w-[343px] sm:h-[64px] h-12 border rounded-lg gap-[10px] flex flex-row items-center">
                <div >
                ...
                <input type="text" className='font-medium' placeholder="Type Course Name..." />
            </div>
        </>
    )
}
