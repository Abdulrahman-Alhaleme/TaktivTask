    ...
    return (
        <>
            <div>
                ...
                <div className={`sm:hidden inline-flex p-4 w-[375px]  flex-col items-center gap-4 border rounded-lg bg-primary_4 transition-opacity transition-transform ease-in-out duration-300 ${FilterButtonVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
